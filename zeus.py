...
import requests
MAINNET_PUBKEY="031b301307574bbe9b9ac7b79cbe1700e31e544513eae0b5d7497483083f99e581@45.79.192.236:9735"
TESTNET_PUBKEY="03e84a109cd70e57864274932fc87c5e6434c59ebb8e6e7d28532219ba38f7f6df@139.144.22.237:9735"
MUTINY_PUBKEY="032ae843e4d7d177f151d021ac8044b0636ec72b1ce3ffcde5c04748db2517ab03@45.79.201.241:9735"
...
class Network(Enum):
    """Available networks for Zeus LSPS1 service."""
    MAINNET = "mainnet"
    TESTNET = "testnet3"
    MUTINYNET = "mutinynet"
...
NETWORK_CONFIGS = {
    Network.MAINNET: NetworkConfig(
        rest_base_url="https://lsps1.lnolymp.us",
        ln_peer_uri=MAINNET_PUBKEY
    ),
    Network.TESTNET: NetworkConfig(
        rest_base_url="https://testnet-lsps1.lnolymp.us",
        ln_peer_uri=TESTNET_PUBKEY
    ),
    Network.MUTINYNET: NetworkConfig(
        rest_base_url="https://mutinynet-lsps1.lnolymp.us",
...
class ZeusLSPS1Client:
    """
    Client for interacting with Zeus LSPS1 API.
    ...
    def __init__(self, network: Network = Network.MAINNET, timeout: int = 30):
        """
        Initialize the Zeus LSPS1 client.
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        """
        return self._make_request('GET', '/api/v1/get_info')
    ...
    def create_order(
        ...
        return self._make_request('POST', '/api/v1/create_order', json=payload)
    ...
    def get_order(self, order_id: str) -> Dict[str, Any]:
        ...
        return self._make_request('GET', '/api/v1/get_order', params=params)
...
class ZeusLSPS1Helper:
    """Helper class with utility functions for working with Zeus LSPS1 API."""
